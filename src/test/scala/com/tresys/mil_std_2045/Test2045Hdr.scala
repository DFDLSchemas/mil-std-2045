...
class Test2045Hdr {
  ...
  // See github https://github.com/DFDLSchemas/mil-std-2045/issues/4 for mil-std-2045
  // Daffodil 2.4.0 fixes Apache Daffodil JIRA DAFFODIL-1493 and DAFFODIL-1477
